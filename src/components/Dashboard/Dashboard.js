...
export default {
    ...
    data: () => ({
        ...
        items: [
            ...
            { tab: 'Six', content: 'Tab 6 Content', text: 'OS / OC', bottom: '5', icon: 'mdi-file-replace-outline' },
            { tab: 'Five', content: 'Tab 5 Content', text: 'Rotas', bottom: '6', icon: 'mdi-vanity-light' },
