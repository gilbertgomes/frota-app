...
export default {
    ...
    methods: {
        insert() {
            ...
            const  urlinsertfabricante = process.env.VUE_APP_HOST  + "fabricante/add/" + key
            
            this.axios.post(urlinsertfabricante, this.fabricante)
            .then(response => {           
    ...
    mounted(){ // gerencia o receber de dados de outro componente
        EventBus.$on('carregacadastro', (fabricante) => {
