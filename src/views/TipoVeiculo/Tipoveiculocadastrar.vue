...
export default {
    ...
    data() {
        return {
            ...
            nomeFormulario: 'Tipo Veiculo'
        }
    },
    methods: {
        insert() {
            const  key = 'frota2021house'
            const  urlinserttipoveiculo = process.env.VUE_APP_HOST  + "tipoveiculo/add/" + key
            
            this.axios.post(urlinserttipoveiculo, this.tipoveiculo)
            .then(response => {           
    ...
    mounted(){ // gerencia o receber de dados de outro componente
        EventBus.$on('carregacadastro', (tipoveiculo) => {
