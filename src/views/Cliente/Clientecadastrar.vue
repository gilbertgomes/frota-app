...
export default {
    ...
    methods: {
        insert() {
            ...
            const  urlinsertcliente = process.env.VUE_APP_HOST  + "cliente/add/" + key
            
            this.axios.post(urlinsertcliente, this.cliente)
            .then(response => {           
    ...
    mounted(){ // gerencia o receber de dados de outro componente
        EventBus.$on('carregacadastro', (cliente) => {
            localStorage.visualiza = cliente.visualiza
            this.dialog = true
            this.alert = true
