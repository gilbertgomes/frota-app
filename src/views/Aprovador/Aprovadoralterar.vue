...
export default {
    ...
    methods: {
        insert() {
            ...
            const  urlinsertaprovador = process.env.VUE_APP_HOST  + "aprovador/alt/" + key
        ...
        novo(){
            ...
            this.aprovador.cargo = ''
            this.aprovador.obs = ''
        }
    },
    mounted(){ // gerencia o receber de dados de outro componente
        EventBus.$on('carregaalteracao', (aprovador) => {
            localStorage.visualiza = aprovador.visualiza
            localStorage.id = aprovador.id
            localStorage.aprovador = aprovador.aprovador
            localStorage.cargo = aprovador.cargo
            localStorage.obs = aprovador.obs

            this.aprovador.id = localStorage.id
            this.aprovador.aprovador = localStorage.aprovador
            this.aprovador.cargo = localStorage.cargo
            this.aprovador.obs = localStorage.obs
            this.dialog = true
            this.alert = true
