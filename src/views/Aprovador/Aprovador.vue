...
export default {
    components: {   
        ...
        Cadastrar: () => import('@/views/Aprovador/Aprovadorcadastrar.vue'),
        Alterar:   () => import('@/views/Aprovador/Aprovadoralterar.vue'),
    },
    name: 'Fabricante',
    data() {
        return {
            ...
            headers: [{
                ...
                { text: 'Cargo', value: 'cargo', class: "cyan dark 1 white--text" },
    ...
    methods: {
        carregaForm() {
            ...
            EventBus.$emit('carregacadastro', this.aprovador)
            this.initialize()
        },
        initialize() {
        ...
        alteraritem(item) {
            this.aprovador.id = item.id
            this.aprovador.aprovador = item.aprovador
            this.aprovador.cargo = item.cargo
