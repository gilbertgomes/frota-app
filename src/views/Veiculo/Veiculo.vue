    ...
    data() {
        return {
            ...
            headers: [{
                ...
                { text: 'Modelo', value: 'modelo', class: "cyan dark 1 white--text" },
                { text: 'Ano', value: 'ano', class: "cyan dark 1 white--text" },
                ...
                { text: 'Acessórios', value: 'acessorio', class: "cyan dark 1 white--text" },
