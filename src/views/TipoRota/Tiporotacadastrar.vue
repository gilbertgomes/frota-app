...
export default {
    ...
    data() {
        return {
            ...
            nomeFormulario: 'Tipo Rota'
        }
    },
    methods: {
        insert() {
            const  key = 'frota2021house'
            const  urlinserttiporota = process.env.VUE_APP_HOST  + "tiporota/add/" + key
            
            this.axios.post(urlinserttiporota, this.tiporota)
            .then(response => {           
    ...
    mounted(){ // gerencia o receber de dados de outro componente
        EventBus.$on('carregacadastro', (tiporota) => {
