...
export default {
    ...
    data() {
        return {
            ...
            headers: [{
                ...
                { text: 'Estoque Tecnico', value: 'minimo', class: "cyan dark 1 white--text" },
    ...
    methods: {
        ...
        getColor(minimo) {
            if (minimo == 10) return 'primary'
            else if (minimo < 10) return 'red'
            else if (minimo < 5) return 'orange'
            else return 'green'           
        },
