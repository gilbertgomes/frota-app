...
export default {
    ...
    methods: {
        insert() {
            ...
            const  urlupdatesolicitante = process.env.VUE_APP_HOST  + "solicitante/alt/" + key
            
            this.axios.post(urlupdatesolicitante, this.solicitante)
            .then(response => {           
    ...
    mounted(){ // gerencia o receber de dados de outro componente
        EventBus.$on('carregaalteracao', (solicitante) => {
            localStorage.visualiza = solicitante.visualiza
            localStorage.id = solicitante.id
            localStorage.solicitante = solicitante.solicitante
            localStorage.setor = solicitante.setor
            localStorage.email = solicitante.email
            localStorage.contato = solicitante.contato

            this.solicitante.id = localStorage.id
            this.solicitante.solicitante = localStorage.solicitante
            this.solicitante.setor = localStorage.setor
            this.solicitante.email = localStorage.email
            this.solicitante.contato = localStorage.contato
            this.dialog = true
            this.alert = true
