...
export default {
    ...
    data() {
        return {
            ...
            nomeFormulario: 'Tipo OS'
        }
    },
    methods: {
        insert() {
            const  key = 'frota2021house'
            const  urlinserttipoos = process.env.VUE_APP_HOST  + "tipoos/add/" + key
            
            this.axios.post(urlinserttipoos, this.tipoos)
            .then(response => {           
    ...
    mounted(){ // gerencia o receber de dados de outro componente
        EventBus.$on('carregacadastro', (tipoos) => {
