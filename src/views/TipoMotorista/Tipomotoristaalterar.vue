...
export default {
    ...
    data() {
        return {
            ...
            nomeFormulario: 'Alterar Tipo Motorista'
        }
    },
    methods: {
        insert() {
            const  key = 'frota2021house'
            const  urlupdatetipocondutor = process.env.VUE_APP_HOST  + "tipocondutor/alt/" + key
            
            this.axios.post(urlupdatetipocondutor, this.tipocondutor)
            .then(response => {           
    ...
    mounted(){ // gerencia o receber de dados de outro componente
        EventBus.$on('carregaalteracao', (tipocondutor) => {
            localStorage.visualiza = tipocondutor.visualiza
            localStorage.id         = tipocondutor.id
            localStorage.tipocondutor = tipocondutor.tipocondutor
            this.tipocondutor.id = localStorage.id
            this.tipocondutor.tipocondutor =  localStorage.tipocondutor
