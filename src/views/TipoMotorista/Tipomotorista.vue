...
export default {
    components: {   
        ...
        Cadastrar: () => import('@/views/TipoMotorista/Tipomotoristacadastrar.vue'),
        Alterar:   () => import('@/views/TipoMotorista/Tipomotoristaalterar.vue'),
    },
    name: 'Fabricante',
    data() {
        return {
            ...
            headers: [{
                ...
                { text: 'Tipo Motorista', value: 'tipocondutor', class: "cyan dark 1 white--text" },
    ...
    methods: {
        carregaForm() {
            this.tipocondutor.visualiza = true
            EventBus.$emit('carregacadastro', this.tipocondutor)
            this.initialize()
        },
        initialize() {
            const  key = 'frota2021house'
            const  urldadostipomotorsta = process.env.VUE_APP_HOST + "tipocondutor/search/" + key

            this.axios.get(urldadostipomotorsta)
            .then(response => {           
        ...
        alteraritem(item) {
            this.tipocondutor.id = item.id
            this.tipocondutor.tipocondutor = item.tipocondutor
            this.tipocondutor.visualiza = true
            EventBus.$emit('carregaalteracao', this.tipocondutor)
            this.initialize()
        },
    },
