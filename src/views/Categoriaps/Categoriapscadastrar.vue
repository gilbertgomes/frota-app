                        ...
                        <v-row>  
                            <v-flex xs12 sm6 md6>
                                <v-select
                                    ...
                                    item-text="" 
                                    item-value=""
                                    label="Categoria Serviço / Peça"
                                    dense
                                    outlined
                                    v-model="categoria.tipo"
                                    value = 'Selecione o Tipo de Serviço / Peças!'
                                    clearable
                                ></v-select>
                            </v-flex> 
                            <v-flex xs12 sm6 md6>
...
export default {
    ...
    methods: {
        insert() {
            ...
            const  urlinsertcategoria = process.env.VUE_APP_HOST  + "categoriaps/add/" + key
            
            this.axios.post(urlinsertcategoria, this.categoria)
            .then(response => {           
    ...
    mounted(){ // gerencia o receber de dados de outro componente
        EventBus.$on('carregacadastro', (categoria) => {
